...
- **App icon**: `scripts/app-icon-source.png` (legacy 1024×1024); `scripts/make-pwa-icons.mjs` writes `public/pwa-*.png` (full-color resize), brand-green silhouettes for `favicon-32-light.png`, `favicon-32-dark.png`, and `apple-touch-icon.png` (#28cd41, alpha from gray source art), before `dev`/`build`
