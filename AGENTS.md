...
- **App icon**: `scripts/app-icon-source.png` (legacy 1024×1024); `scripts/make-pwa-icons.mjs` writes `public/pwa-*.png`, `favicon-32.png`, and `apple-touch-icon.png` before `dev`/`build`
