...
- **App icon**: `scripts/app-icon-source.png` (legacy 1024×1024); `scripts/make-pwa-icons.mjs` writes all shipped icons under `public/` as brand-green silhouettes (#28cd41, alpha from gray source art): `pwa-192.png`, `pwa-512.png`, `favicon-32-light.png`, `favicon-32-dark.png`, `apple-touch-icon.png`, before `dev`/`build`
