...
/** Accent green (matches `src/styles.css` --brand-green) */
const BR = 0x32;
const BG = 0xd7;
const BB = 0x4b;
...
/**
 * Favicon: accent green fill, alpha from luminance × source alpha (gray artwork → green silhouette).
 */
function faviconAccentGreen(src, size) {
...
writePng(join(publicDir, "favicon-32-light.png"), faviconAccentGreen(source, 32));
writePng(join(publicDir, "favicon-32-dark.png"), faviconAccentGreen(source, 32));
